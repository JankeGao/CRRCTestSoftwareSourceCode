...
namespace DF.Web.Areas.BussinessApi.Controllers
{
    ...
    public class CheckListController : BaseApiController
    {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        [LogFilter(Type = LogType.Operate, Name = "同步盘点单")]
        public HttpResponseMessage GetInterfaceCheck()
        {
            HttpResponseMessage response = Request.CreateResponse(HttpStatusCode.OK, CheckListContract.StartCreateOutEntityInterFace().ToMvcJson());
            return response;
        }
