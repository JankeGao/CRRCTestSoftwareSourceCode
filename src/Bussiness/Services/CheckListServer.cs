...
namespace Bussiness.Services
{
    public class CheckListServer : ICheckListContract
    {
        ...
        /// </summary>
        /// <returns></returns>
        public DataResult StartCreateOutEntityInterFace()
        {
            #region Oracle数据获取处理
            int count = 0;
            CheckList entity = new CheckList();
            List<CheckList> entityList = new List<CheckList>();
            CheckListDetail inMaterialObj = null;
            ...
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                ...
                if (resultList.Count > 0)
                {
                    ...
                    {
                        CheckList entityes = new CheckList
                        {
                            Id = 0,
                            CheckDict = 2,
                        ...
                        inMaterialObj = new CheckListDetail
                        {
                            Id = 0,
                            IsDeleted = false,
                        ...
                        if (!CheckLists.Any(a => a.Code == entity.Code))
                        {
                            ...
                            else
                            {
                                ...
                                entityes.AddCheckListDetails.Add(inMaterialObj);
                    ...
                    {
                        entity.AddCheckListDetails.AddRange(tempEntity.AddCheckListDetails); // 将集合中的每个entityes的AddMaterial加入到entity中
                    }
                }
