...
<script>
import { getPageRecords, cancelCheck, handCheck, getCheckDictTypeList, getLocationList, getWarehouseList, getContainerList, postDoCreate, getCheckListMaterialList, getCheckListContainerList, getInterfaceCheck } from '@/api/Mould/CheckList'
